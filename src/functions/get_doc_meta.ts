...
export default async function get_upload_metadata(ctx: GSContext): Promise<GSStatus> {
  ...
  try {
    ...
    return new GSStatus(false, 400, 'Upload Metadata file not found', { error: err });
  }
}
